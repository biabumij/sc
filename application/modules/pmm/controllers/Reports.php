...
class Reports extends CI_Controller {
	...
	public function nilai_persediaan_barang_dashboard($arr_date)
	{
		$data = array();
		...
		<tr class="table-active2">
			<th class="text-right" colspan="5">TOTAL NILAI PERSEDIAAN</th>
			<th class="text-right"><?php echo number_format($total_nilai_akhir,0,',','.');?></th>
		</tr>
	</table>
	<?php
	...
	public function pergerakan_bahan_jadi_penyesuaian($arr_date)
	{
		...
		<table class="table table-bordered" width="100%">
		 <style type="text/css">
			...
			$tanggal_penyesuaian = date('Y-m-d', strtotime('-1 days', strtotime($date1)));

			$stock_opname_penyesuaian = $this->db->select('cat.abubatu, cat.batu0510, cat.batu1020, cat.batu2030')
			->from('penyesuaian_stok cat ')
			->where("(cat.date_penyesuaian = '$tanggal_opening_balance')")
			->where("cat.status = 'PUBLISH'")
			...
			$volume_opening_balance_batu1020_bulan_lalu = $stock_opname_penyesuaian['batu1020'] + $stock_opname_batu1020_ago['volume'];
			$volume_opening_balance_batu2030_bulan_lalu = $stock_opname_penyesuaian['batu2030'] + $stock_opname_batu2030_ago['volume'];
			...
			$stock_opname_penyesuaian_now = $this->db->select('cat.abubatu, cat.batu0510, cat.batu1020, cat.batu2030')
			->from('penyesuaian_stok cat ')
			->where("(cat.date_penyesuaian = '$date2')")
			->where("cat.status = 'PUBLISH'")
			->order_by('cat.date_penyesuaian','desc')->limit(1)
			->get()->row_array();
			...
			$volume_akhir_agregat_abubatu_bulan_ini_2 = $stock_opname_penyesuaian_now['abubatu'] + $stock_opname_abu_batu['volume'];
			$volume_akhir_agregat_batu0510_bulan_ini_2 = $stock_opname_penyesuaian_now['batu0510'] + $stock_opname_batu0510['volume'];
			$volume_akhir_agregat_batu1020_bulan_ini_2 = $stock_opname_penyesuaian_now['batu1020'] + $stock_opname_batu1020['volume'];
			$volume_akhir_agregat_batu2030_bulan_ini_2 = $stock_opname_penyesuaian_now['batu2030'] + $stock_opname_batu2030['volume'];
	...
	public function pergerakan_bahan_jadi_penyesuaian_dashboard($arr_date)
	{
		$data = array();
		...
		<table class="table table-bordered" width="100%">
		 <style type="text/css">
			...
			<tr>
				...
				<th class="text-center">Ton</th>
				<th class="text-center" style="<?php echo $styleColorAA ?>"><?php echo number_format($volume_akhir_agregat_abubatu_bulan_ini_2,2,',','.');?></th>
				<th class="text-right"><?php echo number_format($harga_akhir_agregat_abubatu_bulan_ini_2,0,',','.');?></th>
			...
			<tr>
				...
				<th class="text-center">Ton</th>
				<th class="text-center" style="<?php echo $styleColorC ?>"><?php echo number_format($volume_akhir_agregat_batu0510_bulan_ini_2,2,',','.');?></th>
				<th class="text-right"><?php echo number_format($harga_akhir_agregat_batu0510_bulan_ini_2,0,',','.');?></th>
			...
			<tr>
				...
				<th class="text-center">Ton</th>
				<th class="text-center" style="<?php echo $styleColorE ?>"><?php echo number_format($volume_akhir_agregat_batu1020_bulan_ini_2,2,',','.');?></th>
				<th class="text-right"><?php echo number_format($harga_akhir_agregat_batu1020_bulan_ini_2,0,',','.');?></th>
			...
			<tr>
				...
				<th class="text-center">Ton</th>
				<th class="text-center" style="<?php echo $styleColorG ?>"><?php echo number_format($volume_akhir_agregat_batu2030_bulan_ini_2,2,',','.');?></th>
				<th class="text-right"><?php echo number_format($harga_akhir_agregat_batu2030_bulan_ini_2,0,',','.');?></th>
				<th class="text-right" style="<?php echo $styleColorH ?>"><?php echo number_format($nilai_akhir_agregat_batu2030_bulan_ini_2,0,',','.');?></th>
	        </tr>
			<tr>
				<th class="text-center" colspan="3">TOTAL</th>
				<th class="text-center" style="<?php echo $styleColorAA ?>"><?php echo number_format($total_volume_akhir,2,',','.');?></th>
				<th class="text-right">-</th>
	...
	public function evaluasi_nilai_persediaan($arr_date)
	{
		...
		<table class="table table-bordered" width="100%">
		 <style type="text/css">
			...
			$stok_volume_akhir_agregat_abubatu_bulan_ini_2 = $stock_opname_abu_batu['volume'];
			$stok_volume_akhir_agregat_batu0510_bulan_ini_2 = $stock_opname_batu0510['volume'];
			$stok_volume_akhir_agregat_batu1020_bulan_ini_2 = $stock_opname_batu1020['volume'];
			$stok_volume_akhir_agregat_batu2030_bulan_ini_2 = $stock_opname_batu2030['volume'];
			...
			$stok_total_volume_akhir = $stok_volume_akhir_penjualan_abubatu_bulan_ini + $stok_volume_akhir_penjualan_batu0510_bulan_ini + $stok_volume_akhir_penjualan_batu1020_bulan_ini + $stok_volume_akhir_penjualan_batu2030_bulan_ini;
			$stok_total_nilai_akhir = $stok_nilai_akhir_penjualan_abubatu_bulan_ini + $stok_nilai_akhir_penjualan_batu0510_bulan_ini + $stok_nilai_akhir_penjualan_batu1020_bulan_ini + $stok_nilai_akhir_penjualan_batu2030_bulan_ini;
			...
			<tr class="table-active3">		
				<th class = "text-left"><i>Batu 0,0 - 0,5</i></th>
				<th class = "text-center">Ton</th>
				<th class = "text-center"><?php echo number_format($stok_volume_akhir_penjualan_abubatu_bulan_ini,2,',','.');?></th>
				<th class = "text-right"><?php echo number_format($stok_harga_akhir_penjualan_abubatu_bulan_ini,0,',','.');?></th>
				<th class = "text-right"><?php echo number_format($stok_nilai_akhir_penjualan_abubatu_bulan_ini,0,',','.');?></th>
				<th class = "text-center"><?php echo number_format($volume_akhir_agregat_abubatu_bulan_ini_2,2,',','.');?></th>
				<th class = "text-right"><?php echo number_format($harga_akhir_agregat_abubatu_bulan_ini_2,0,',','.');?></th>
				<th class = "text-right"><?php echo number_format($nilai_akhir_agregat_abubatu_bulan_ini_2,0,',','.');?></th>
			...
			<tr class="table-active3">
				<th class = "text-left"><i>Batu 0,5 - 10</i></th>
				<th class = "text-center">Ton</th>
				<th class = "text-center"><?php echo number_format($stok_volume_akhir_penjualan_batu0510_bulan_ini,2,',','.');?></th>
				<th class = "text-right"><?php echo number_format($stok_harga_akhir_penjualan_batu0510_bulan_ini,0,',','.');?></th>
				<th class = "text-right"><?php echo number_format($stok_nilai_akhir_penjualan_batu0510_bulan_ini,0,',','.');?></th>
				<th class = "text-center"><?php echo number_format($volume_akhir_agregat_batu0510_bulan_ini_2,2,',','.');?></th>
				<th class = "text-right"><?php echo number_format($harga_akhir_agregat_batu0510_bulan_ini_2,0,',','.');?></th>
				<th class = "text-right"><?php echo number_format($nilai_akhir_agregat_batu0510_bulan_ini_2,0,',','.');?></th>
			...
			<tr class="table-active3">
				<th class = "text-left"><i>Batu 10 - 20</i></th>
				<th class = "text-center">Ton</th>
				<th class = "text-center"><?php echo number_format($stok_volume_akhir_penjualan_batu1020_bulan_ini,2,',','.');?></th>
				<th class = "text-right"><?php echo number_format($stok_harga_akhir_penjualan_batu1020_bulan_ini,0,',','.');?></th>
				<th class = "text-right"><?php echo number_format($stok_nilai_akhir_penjualan_batu1020_bulan_ini,0,',','.');?></th>
				<th class = "text-center"><?php echo number_format($volume_akhir_agregat_batu1020_bulan_ini_2,2,',','.');?></th>
				<th class = "text-right"><?php echo number_format($harga_akhir_agregat_batu1020_bulan_ini_2,0,',','.');?></th>
				<th class = "text-right"><?php echo number_format($nilai_akhir_agregat_batu1020_bulan_ini_2,0,',','.');?></th>
			...
			<tr class="table-active3">		
				<th class = "text-left"><i>Batu 20 - 30</i></th>
				<th class = "text-center">Ton</th>
				<th class = "text-center"><?php echo number_format($stok_volume_akhir_penjualan_batu2030_bulan_ini,2,',','.');?></th>
				<th class = "text-right"><?php echo number_format($stok_harga_akhir_penjualan_batu2030_bulan_ini,0,',','.');?></th>
				<th class = "text-right"><?php echo number_format($stok_nilai_akhir_penjualan_batu2030_bulan_ini,0,',','.');?></th>
				<th class = "text-center"><?php echo number_format($volume_akhir_agregat_batu2030_bulan_ini_2,2,',','.');?></th>
				<th class = "text-right"><?php echo number_format($harga_akhir_agregat_batu2030_bulan_ini_2,0,',','.');?></th>
				<th class = "text-right"><?php echo number_format($nilai_akhir_agregat_batu2030_bulan_ini_2,0,',','.');?></th>
