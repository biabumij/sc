                        ...
                        <div class="panel">
                            ...
                            <div class="panel-content">
                                ...
                                <div id="alert-receipt-material-total" class="row"></div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 text-right">
                                            <a href="<?php echo site_url('admin/penjualan#profile'); ?>" class="btn btn-info" style="margin-top:10px; width:100px; font-weight:bold;"><i class="fa fa-arrow-left"></i> Kembali</a>
                                ...
                                <div class="text-right">
                                    <button class="btn btn-danger" id="btn-view" style="width:100px; font-weight:bold; font-weight:bold;"><i class="fa fa-search"></i> Lihat Data</button>
                                </div>
