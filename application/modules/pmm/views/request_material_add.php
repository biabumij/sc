            ...
            <div class="content-header">
                <div class="leftside-content-header">
                    <ul class="breadcrumbs">
                        ...
                        <li>
                            <a href="<?php echo site_url('admin/pembelian');?>"> <i class="fa fa-calendar" aria-hidden="true"></i> Permintaan Bahan & Alat</a></li>
                        <li><a>Edit Permintaan Bahan & Alat</a></li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-content">
                            ...
                            <div class="text-right">
                                <a href="<?php echo site_url('admin/pembelian#chart');?>" class="btn btn-info"><i class="fa fa-mail-reply"></i> Kembali</a>
                                <?php
                                if($data['status'] == 'DRAFT'){
                                    ?>
