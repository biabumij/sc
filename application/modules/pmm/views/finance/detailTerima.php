                            ...
                            <div class="panel-content">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 text-right">
                                        ...
                                        <a target="_blank" href="<?= base_url('pmm/finance/cetakTerimaCoa/'.$detail["id"]) ?>" class="btn btn-default" style="width:10%; font-weight:bold; font-weight:bold;"><i class="fa fa-print"></i> Cetak</a>
                                        <?php
                                        if($this->session->userdata('admin_group_id') == 1 || $this->session->userdata('admin_group_id') == 5 || $this->session->userdata('admin_group_id') == 6 || $this->session->userdata('admin_group_id') == 10 || $this->session->userdata('admin_group_id') == 13 || $this->session->userdata('admin_group_id') == 14 || $this->session->userdata('admin_group_id') == 15){
                                            ?>
                                            <a class="btn btn-danger" onclick="DeleteData('<?= site_url('pmm/finance/deleteTerimaCoa/'.$detail['id']);?>')" style="width:10%; font-weight:bold; font-weight:bold;"><i class="fa fa-close"></i> Hapus</a>
