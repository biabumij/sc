                            ...
                            <div class="panel-content">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 text-right">
                                        ...
                                        <a target="_blank" href="<?= base_url('pmm/finance/cetakTransferCoa/'.$detail["id"]) ?>" class="btn btn-default" style="width:15%; font-weight:bold;"><i class="fa fa-print"></i> Cetak</a>
                                        <?php
