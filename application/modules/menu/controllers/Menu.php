	...
	function table()
	{
		...
		if($check == true){		
	        ...
	        foreach ($list as $value) {
	            ...
	            $btn_edit = '<a class="btn btn-sm btn-primary" style="font-weight:bold;" href="'.$url_edit.'"><i class="glyphicon glyphicon-pencil"></i> Edit</a>';
	            $btn_delete = '<a class="btn btn-sm btn-danger" style="font-weight:bold;" href="javascript:void(0)" onclick="delete_person('."'".$url_del."'".')"><i class="glyphicon glyphicon-trash"></i> Delete</a>';
