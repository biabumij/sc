                                                    ...
                                                    <div id="box-print" class="table-responsive">
                                                        ...
                                                        <table class="mytable table-hover table-center table-condensed" id="table-date8a" style="display:none" width="100%";>
                                                            <thead>
																...
																<th align="center">Pemakaian Bahan</th>
                        ...
                        if (result.data) {
                            ...
                            if (result.data.length > 0) {
                                $.each(result.data, function(i, val) {
                                    $('#table-date8a tbody').append('<tr onclick="NextShowLaporanProduksi(' + val.no + ')" class="active" style="font-weight:bold;cursor:pointer;"><td class="text-center">' + val.no + '</td><td class="text-center"><b>' + val.date_prod + '</b></td><td class="text-center"><b>' + val.jumlah_duration + '</b></td><td class="text-center"><b>' + val.jumlah_used + '</b></td><td class="text-center"><b>' + 'Ton' + '</b></td></tr>');
