                            ...
                            <div class="panel-content">
                                ...
                                <div class="text-center">
                                    <?php if ($penagihan["status"] === "OPEN") : ?>
                                        <a href="<?= base_url("penjualan/cetak_penagihan_penjualan/".$penagihan["id"]) ?>" target="_blank" class="btn btn-info" style="width:15%; font-weight:bold;"><i class="fa fa-print"></i> Cetak PDF</a>
                                        <?php
