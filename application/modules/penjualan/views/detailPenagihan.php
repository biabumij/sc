                            ...
                            <div class="panel-content">
                                ...
                                <div class="text-center">
                                    <?php if ($penagihan["status"] === "OPEN") : ?>
                                        <a href="<?= base_url("penjualan/cetak_penagihan_penjualan/".$penagihan["id"]) ?>" target="_blank" class="btn btn-default" style="width:15%; font-weight:bold;"><i class="fa fa-print"></i> Print</a>
                                        <?php
                                ...
                                <div class="text-center">
                                    <?php if ($penagihan["status"] === "CLOSED") : ?>
                                        ...
                                        <?php
                                        ?>
                                        <a href="<?= site_url('penjualan/open_penagihan/' . $penagihan['id']); ?>" class="btn btn-success" style="width:15%; font-weight:bold;"><i class="fa fa-folder-open-o"></i> Pembayaran Belum Lunas</a>
                                        <?php
                                        }
                                        ?>
