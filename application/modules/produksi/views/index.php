                        ...
                        <div class="panel">
                            ...
                            <div class="panel-content">
                                <ul class="nav nav-tabs" role="tablist">
									<li role="presentation"  class="active"><a href="#kalibrasi" aria-controls="kalibrasi" role="tab" data-toggle="tab" style="font-weight:bold;">Kalibrasi</a></li>
									<li role="presentation"><a href="#komposisi_agregat" aria-controls="komposisi_agregat" role="tab" data-toggle="tab" style="font-weight:bold;">Komposisi Agregat</a></li>
									<li role="presentation"><a href="#produksi_harian" aria-controls="produksi_harian" role="tab" data-toggle="tab" style="font-weight:bold;">Produksi Harian</a></li>
									<li role="presentation"><a href="#produksi_campuran" aria-controls="produksi_campuran" role="tab" data-toggle="tab" style="font-weight:bold;">Produksi Campuran</a></li>
                                    <li role="presentation"><a href="#material_on_site" aria-controls="material_on_site" role="tab" data-toggle="tab" style="font-weight:bold;">Stock Opname</a></li>
                                </ul>
