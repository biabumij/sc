                    ...
                    <div class="panel">
                        ...
                        <div class="panel-content">
                            ...
                            <div class="text-right">
                                ...
                                <a href="<?= base_url("produksi/cetak_produksi_campuran/".$prod["id"]) ?>" target="_blank" class="btn btn-default" style="width:15%; font-weight:bold;"><i class="fa fa-print"></i> Print</a>
                                <?php
