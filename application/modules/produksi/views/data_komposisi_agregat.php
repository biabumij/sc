                    ...
                    <div class="panel">
                        ...
                        <div class="panel-content">
                            ...
                            <div class="text-right">
                                ...
                                <a href="<?= base_url("produksi/cetak_komposisi_agregat/".$agregat["id"]) ?>" target="_blank" class="btn btn-default" style="width:15%; font-weight:bold;"><i class="fa fa-print"></i> Cetak PDF</a>
                                ...
                                ?>
								<a class="btn btn-danger" onclick="DeleteData('<?= site_url('produksi/hapus_komposisi_agregat/'.$agregat['id']);?>')" style="width:15%; font-weight:bold;"><i class="fa fa-close"></i> Hapus</a>
                                <?php
                                }
                                ?>
                            </div>
