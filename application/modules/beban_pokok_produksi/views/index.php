                                            ...
                                            <div width="100%">
                                                <div class="panel panel-default">
													<div class="col-sm-5">
                                                        ...
                                                        <a href="#beban_pokok_produksi" aria-controls="beban_pokok_produksi" role="tab" data-toggle="tab" class="btn btn-primary" style="font-weight:bold;">Lihat Laporan</a>										
                                                    </div>
													<!--<div class="col-sm-5">
														<p><h5>Pergerakan Bahan Baku (Rumus)</h5></p>
														<p style='color:red; font-weight:bold;'><blink>Periode Februari 2021 sd. Mei 2022</blink></p>
                                                        <a href="#pergerakan_bahan_baku" aria-controls="pergerakan_bahan_baku" role="tab" data-toggle="tab" class="btn btn-primary" style="font-weight:bold;">Lihat Laporan</a>
													</div>
													<div class="col-sm-5">
														<p><h5>Pergerakan Bahan Jadi (Rumus)</h5></p>
														<p style='color:red; font-weight:bold;'><blink>Periode Februari 2021 sd. Mei 2022</blink></p>
                                                        <a href="#pergerakan_bahan_jadi" aria-controls="pergerakan_bahan_jadi" role="tab" data-toggle="tab" class="btn btn-primary" style="font-weight:bold;">Lihat Laporan</a>
													</div>-->
                                                    <div class="col-sm-5">
														<p><h5>Pergerakan Bahan Baku</h5></p>
														<p style='color:red; font-weight:bold;'><blink>Periode Juni 2022 sd. sekarang</blink></p>
                                                        <a href="#pergerakan_bahan_baku_penyesuaian" aria-controls="pergerakan_bahan_baku_penyesuaian" role="tab" data-toggle="tab" class="btn btn-primary" style="font-weight:bold;">Lihat Laporan</a>
													</div>
                                                    <div class="col-sm-5">
