                            ...
                            if (result.data.length > 0) {
                                $.each(result.data, function(i, val) {
                                    ...
                                    $.each(val.mats, function(a, row) {
                                        var a_no = a + 1;
                                        $('#table-date tbody').append('<tr style="display:none;" class="mats-' + val.no + '"><td class="text-center">' + val.no + '.' + a_no + '</td><td class="text-center">' + row.purchase_order_id + '</td><td class="text-left">' + row.nama_produk + '</td><td class="text-center">' + row.measure + '</td><td class="text-right">' + row.volume + '</td><td class="text-right">' + row.price + '</td><td class="text-right">' + row.total_price + '</td></tr>');
                                    });
                        ...
                        if (result.data) {
                            ...
                            if (result.data.length > 0) {
                                $.each(result.data, function(i, val) {
                                    ...
                                    $.each(val.mats, function(a, row) {
                                        var a_no = a + 1;
                                        $('#table-date-sewa-alat tbody').append('<tr style="display:none;" class="mats-' + val.no + '"><td class="text-center">' + val.no + '.' + a_no + '</td><td class="text-center">' + row.purchase_order_id + '</td><td class="text-left">' + row.nama_produk + '</td><td class="text-center">' + row.measure + '</td><td class="text-right">' + row.volume + '</td><td class="text-right">' + row.price + '</td><td class="text-right">' + row.total_price + '</td></tr>');
                                    });
                        ...
                        if (result.data) {
                            ...
                            if (result.data.length > 0) {
                                $.each(result.data, function(i, val) {
                                    ...
                                    $.each(val.mats, function(a, row) {
                                        var a_no = a + 1;
                                        $('#table-date-jasa-angkut tbody').append('<tr style="display:none;" class="mats-' + val.no + '"><td class="text-center">' + val.no + '.' + a_no + '</td><td class="text-center">' + row.purchase_order_id + '</td><td class="text-left">' + row.nama_produk + '</td><td class="text-center">' + row.measure + '</td><td class="text-right">' + row.volume + '</td><td class="text-right">' + row.price + '</td><td class="text-right">' + row.total_price + '</td></tr>');
                                    });
                            ...
                            if (result.data.length > 0) {
                                $.each(result.data, function(i, val) {
                                    ...
                                    $.each(val.mats, function(a, row) {
									 ...
									 $('#table-date2 tbody').append('<tr style="display:none;" class="mats-' + val.no + '"><td class="text-right" colspan="8"><b>JUMLAH</b></td><td class="text-right" colspan="9"><b>' + val.jumlah + '</b></td></tr>');
                                });
