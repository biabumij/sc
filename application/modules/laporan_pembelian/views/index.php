                     ...
                     success: function(result) {
                        if (result.data) {
                            ...
                            if (result.data.length > 0) {
                                ...
                                $('#penerimaan-pembelian tbody').append('<tr style="background-color:#bcbcbc;"><td class="text-right" colspan="3"><b>TOTAL</b></td><td class="text-right" ><b>' + result.total_volume + '</b></td><td class="text-right" ></td><td class="text-right" ><b>' + result.total_nilai + '</b></td></tr>');
                            } else {
