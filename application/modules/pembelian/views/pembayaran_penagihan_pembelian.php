                            ...
                            <div class="panel-content">
                                <form method="POST" action="<?php echo site_url('pembelian/submit_pembayaran_penagihan_pembelian');?>" id="form-po" enctype="multipart/form-data" autocomplete="off">
                                    ...
                                    <div class="text-center">
                                        <a href="<?= site_url('pembelian/penagihan_pembelian_detail/'.$pembayaran["id"]);?>" class="btn btn-danger" style="margin-bottom:0px; width:100px; font-weight:bold;"><i class="fa fa-close"></i> Batal</a>
