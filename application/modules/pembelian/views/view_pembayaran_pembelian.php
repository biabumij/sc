                    ...
                    <div class="col-sm-12 col-lg-12">
                        <div class="panel">
                            ...
                            <div class="panel-content">
                                    ...
                                    <a href="<?= base_url('pembelian/cetak_pembayaran_penagihan_pembelian/' . $bayar["id"]) ?>" target="_blank" class="btn btn-default" style="width:15%; font-weight:bold;"><i class="fa fa-print"></i> Print</a>
                                    ...
                                    ?>
                                    <td width="10%"><a href="<?= base_url('pembelian/sunting_pembayaran_pembelian/' . $bayar["id"]) ?>" class="btn btn-default" style="width:15%; font-weight:bold;"><i class="fa fa-edit"></i> Edit</a></td>
                                    <?php
                                    }
                                    ?>
