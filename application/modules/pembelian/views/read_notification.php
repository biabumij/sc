                                ...
                                <div class="row">
                                    <div class="col-sm-10">
                                        <table class="table table-bordered table-striped table-condensed">
                                            ...
                                            ?> 
                                            <tr>
                                                <th width = "50%"><a href="<?= site_url('pembelian/closed_verifikasi/' . $x['id']); ?>" class="btn btn-success" style="font-weight:bold;"><i class="fa fa-check"></i> Setujui - (<?= $x['nomor_invoice'];?>)</a></th>
                                                <th width = "50%"><a target="_blank" a href="<?= site_url('pembelian/print_verifikasi_penagihan_pembelian/?id='.$x['id']); ?>" class="btn btn-default" style="font-weight:bold;"><i class="fa fa-print"></i> Print</a></th>
                                            </tr>
                                            <tr>
