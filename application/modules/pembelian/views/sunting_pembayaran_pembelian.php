                                ...
                                <form method="POST" action="<?php echo site_url('pembelian/simpan_pembayaran_pembelian');?>" id="form-po" enctype="multipart/form-data" autocomplete="off">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 text-center">
                                            <a href="<?= site_url('pembelian/penagihan_pembelian_detail/'.$pembayaran["id"]);?>" class="btn btn-danger" style="margin-bottom:0; width:100px; font-weight:bold;"><i class="fa fa-close"></i> Batal</a>
