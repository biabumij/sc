                        ...
                        <div class="panel">
                            ...
                            <div class="text-center">
                                ...
                                <?php if ($row["verifikasi_dok"] === "SUDAH") : ?>
                                    ...
                                    ?>
                                        ...
                                        <a href="<?= base_url('pembelian/sunting_verifikasi/' . $row["id"]) ?>" class="btn btn-default" style="width:15%; font-weight:bold;"><i class="fa fa-edit"></i> Edit Verifikasi</a>
                            ...
                            <div class="container-fluid">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li role="presentation"><a href="#menu2" aria-controls="menu2" role="tab" data-toggle="tab" style="font-weight:bold; border-radius:10px 0px 10px 0px;">Daftar Pembayaran</a></li>
                                </ul>
