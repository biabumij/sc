                                ...
                                <div class="text-center">
                                    ...
                                    <?php if($row["status"] === "DRAFT") : ?>
                                        ...
                                        ?>
                                            ...
                                            <form class="form-check" action="<?= base_url("pembelian/reject_penawaran_pembelian/".$row["id"]) ?>">
                                                <button type="submit" class="btn btn-danger" style="margin-top:10px; width:150px; font-weight:bold;"><i class="fa fa-close"></i> Tolak</button>        
                                            </form>
                                        <?php
                                        }
                                        ?>
                                    ...
                                    <?php
                                        ...
                                        ?>
                                            ...
                                            <button type="submit" class="btn btn-danger" style="width:150px; font-weight:bold;"><i class="fa fa-briefcase"></i> Closed</button>     
                                            </form>
                                            <form class="form-check" action="<?= base_url("pembelian/reject_penawaran_pembelian/".$row["id"]) ?>">
                                                <button type="submit" class="btn btn-danger" style="width:150px; font-weight:bold;"><i class="fa fa-close"></i> Reject</button>        
                                            </form>	
                                        <?php
                                        }
                                        ?>
                                    ...
                                    <?php if($row["status"] === "CLOSED") : ?>
                                        ...
                                        ?>
                                            <form class="form-check" action="<?= base_url("pembelian/open_penawaran_pembelian/".$row["id"]) ?>">
                                                <button type="submit" class="btn btn-success" style="width:150px; font-weight:bold;"><i class="fa fa-folder-open-o"></i> Open</button>        
                                            </form>	
                                        <?php
                                        }
                                        ?>
                                        ...
                                        ?>
                                            <form class="form-check" action="<?= base_url("pembelian/hapus_penawaran_pembelian/".$row["id"]) ?>">
                                                <button type="submit" class="btn btn-danger" style="margin-top:10px; width:150px; font-weight:bold;"><i class="fa fa-trash"></i> Hapus</button>
                                            </form>
                                        <?php
                                        }
                                        ?>
                                    ...
                                    <?php if($row["status"] === "REJECT") : ?>
                                        ...
                                        ?>
                                            <form class="form-check" action="<?= base_url("pembelian/hapus_penawaran_pembelian/".$row["id"]) ?>">
                                            <button type="submit" class="btn btn-danger" style="width:150px; font-weight:bold;"><i class="fa fa-trash"></i> Hapus</button>        
                                            </form>	
                                        <?php
                                        }
                                        ?>
